...
public class AdminService {
    ...
    public com.ayurkisan.dto.DashboardStats getDashboardStats() {
        ...
        for (com.ayurkisan.Modules.Orders.Order order : orders) {
            ...
            // Count ALL orders (Gross) - This matches what user expects to see in Order Management
            ...
            // Skip cancelled or returned orders ONLY for revenue calculations (Net Sales)
        ...
        stats.setTotalOrders(customerOrdersCount + retailerOrdersCount);
