...
public class CartItem {
    ...
    private Integer quantity; // Represents actual physical quantity of items

    private double price; // Original unit price

    private double discountedPrice; // Unit price with admin discount applied
